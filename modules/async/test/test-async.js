...
function isBrowser() {
    return typeof process === 'undefined' || process + '' !== '[object process]';
}
...
exports['each'] = function (test) {
    ...
    async.each([
        ...
        3,
        2
    ], eachIteratee.bind(this, args), function (err) {
        test.ok(err === null, err + ' passed instead of \'null\'');
        test.same(args, [
            1,
            2,
...
exports['forEachOf'] = function (test) {
    ...
    async.forEachOf({
        a: 1,
        b: 2
    }, forEachOfIteratee.bind(this, args), function (err) {
        test.ok(err === null, err + ' passed instead of \'null\'');
        test.same(args, [
            'a',
            1,
...
exports['map'] = {
    'basic': function (test) {
        ...
        async.map([
            ...
            3,
            2
        ], mapIteratee.bind(this, call_order), function (err, results) {
            test.ok(err === null, err + ' passed instead of \'null\'');
            test.same(call_order, [
                1,
                2,
    ...
    'with reflect': function (test) {
        ...
        async.map([
            ...
            3,
            2
        ], async.reflect(function (item, cb) {
            setTimeout(function () {
    ...
    'mapLimit': function (test) {
        ...
        async.mapLimit([
            ...
            4,
            3
        ], 2, mapIteratee.bind(this, call_order), function (err, results) {
            test.ok(err === null, err + ' passed instead of \'null\'');
            test.same(call_order, [
                2,
                4,
    ...
    'mapLimit limit exceeds size': function (test) {
        ...
        async.mapLimit([
            ...
            8,
            9
        ], 20, mapIteratee.bind(this, call_order), function (err, results) {
            test.same(call_order, [
                0,
                1,
                2,
    ...
    'mapLimit limit equal size': function (test) {
        ...
        async.mapLimit([
            ...
            8,
            9
        ], 10, mapIteratee.bind(this, call_order), function (err, results) {
            test.same(call_order, [
                0,
                1,
                2,
...
exports['apply'] = function (test) {
    test.expect(6);
    var fn = function () {
        test.same(Array.prototype.slice.call(arguments), [
            1,
            2,
            3,
            4
